...
SOURCES += cf_query.c client-run.c config_db.c db_creation.c er_errors.c kr_controller.c libluasqlite3.c ld_create.c ld_log_db.c ld_logging.c sa_sensor_list_log_db.c sa_sensor_mark.c up_shared.c utils_cl2.c
...
!isEmpty(WITH_LIBEV) {
  SOURCES += sa_sensor_timer_libev.c ut_timer_libev.c
  LIBS += -lev
}
unix {
  TARGET = main
